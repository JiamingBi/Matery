...
public class ProgramRunner {
    ...
    public static  void runProgramTab(ProgramTab programTab) throws Exception{
        ...
        try{
            ...
            else if(programType == FileType.PROGRAM_MT){
                programOutput = ProgramRunner.getMTProgramOutput(tmpDir, programTab.getName());
            }
    ...
    private static String getMTProgramOutput(File tmpDir, String programName) throws Exception{

        // string values of interpreter dir and executable
        String interpreterDir = "interpreter";
        String interpreterExe = "matery";
        ...
        try{
            ...
            throw new Exception("Unable to cache MT interpreter in tmp directory.\n" +
                    "Cause : \n\t" + e.toString());
        }
