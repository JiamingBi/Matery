...
public enum FileType { 
    ...
    PROGRAM_MT(
            ...
            ".mt",
            // ALL EXTENSIONS
            new ArrayList<String>(Arrays.asList(".mt")),
            // EXTENSION FILTERS
            new ExtensionFilter[] {new ExtensionFilter("MT Program (*.mt)", "*.mt")},
            ...
            "<!doctype html>" +
                    ...
                    "   <script src=\"" + Resources.CODE_MIRROR_PATH + "/mode/mt/mt.js\"></script>" +
                    "</head>" +
    ...
    public static FileType getFileType(String filename){
        ...
        // MT PROGRAM
        else if(FileType.PROGRAM_MT.fileHasSameFileType(filename)){
            return FileType.PROGRAM_MT;
        }
        // TABLE
